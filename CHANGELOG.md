...
### Added
- **New Branding**: Replaced the placeholder logo with a custom-designed EESA SVG logo in the dashboard header, featuring a modern gradient and responsive theme-aware styling.

## [1.4.3] - 2026-01-01

### Added
- **Adaptive UI Polling**: Implemented a dynamic refresh mechanism for the dashboard. The UI now polls for updates every 1 second during active synchronization for a real-time feel, and automatically throttles down to every 10 seconds when idle to conserve system resources.

## [1.4.2] - 2026-01-01

### Added
- **Interactive Tooltips**: Added informative tooltips across the Synchronization Engine, Settings, and Intelligence Hub to provide inline guidance for all features and configuration options.
